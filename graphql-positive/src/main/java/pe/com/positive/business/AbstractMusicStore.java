 ...
 * 
 * @Author: JomaPozo.
 * @Datecreation: 11 jun. 2017 20:03:22
 * @FileName: AbstractMusicStore.java
 * @AuthorCompany: 
 * @version: 0.1
 * @Description: class for mocks inserts
 */
public abstract class AbstractMusicStore implements IMusicStore {

    @Autowired
    private ArtistaRepository artistaRepo;

    protected void addMockLedZepellin(){
	  ...
	  Set<Track> allTracks = new LinkedHashSet<>();
	  ...
	  artista.setTracks(allTracks);

	  artistaRepo.save(artista);
    }

    protected Artista addMockMichaelJackson(){
	  Artista artista = new Artista();
    ...
    protected Artista addMockLennyKravitz(){
	  Artista artista = new Artista();
	  artista.setName("Lenny Kravitz");
	  artista.setImageUrl("https://www.google.com.pe/image/lenny-kravitz");
	  ...
	  Album album = new Album();
	  album.setName("Mama Said");
	  album.setImageUrl("https://www.google.com.pe/image/album/mama-said");
	  album.setArtist(artista);

	  Track track = new Track();
	  track.setTrackNumber(1);
	  track.setName("Always on the Run");
	  track.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/mama-said/track/1");
	  track.setAlbum(album);

	  Track track1 = new Track();
	  track1.setTrackNumber(2);
	  track1.setName("It Ain't Over 'til It's Over");
	  track1.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/mama-said/track/2");
	  track1.setAlbum(album);

	  Track track2 = new Track();
	  track2.setTrackNumber(3);
	  track2.setName("Stand by My Woman");
	  track2.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/mama-said/track/3");
	  track2.setAlbum(album);
	  ...
	  Album album1 = new Album();
	  album1.setName("Are You Gonna Go My Way");
	  album1.setImageUrl("https://www.google.com.pe/image/album/are-you-gonna-go-my-way");
	  album1.setArtist(artista);
	  ...
	  Track tracka = new Track();
	  tracka.setTrackNumber(1);
	  tracka.setName("Heaven Help");
	  tracka.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/are-you-gonna-go-my-way/track/1");
	  tracka.setAlbum(album1);

	  Track trackb = new Track();
	  trackb.setTrackNumber(2);
	  trackb.setName("Believe");
	  trackb.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/are-you-gonna-go-my-way/track/2");
	  trackb.setAlbum(album1);

	  Track trackc = new Track();
	  trackc.setTrackNumber(3);
	  trackc.setName("Come on and Love Me");
	  trackc.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/are-you-gonna-go-my-way/track/3");
	  trackc.setAlbum(album1);
	  ...
	  // ***************************************
	  Album album2 = new Album();
	  album2.setName("Circus");
	  album2.setImageUrl("https://www.google.com.pe/image/album/circus");
	  album2.setArtist(artista);
	  ...
	  Track track01 = new Track();
	  track01.setTrackNumber(1);
	  track01.setName("Rock and Roll Is Dead");
	  track01.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/circus/track/1");
	  track01.setAlbum(album2);

	  Track track02 = new Track();
	  track02.setTrackNumber(2);
	  track02.setName("Beyond the 7th sky");
	  track02.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/circus/track/2");
	  track02.setAlbum(album2);

	  Track track03 = new Track();
	  track03.setTrackNumber(3);
	  track03.setName("God is love");
	  track03.setPreviewUrl("https://www.google.com.pe/lenny-kravitz/circus/track/3");
	  track03.setAlbum(album2);
    ...
    public static void main(String [] args){
	  AbstractMusicStore a = new AbstractMusicStore() {
	  ...
	  a.addMockMichaelJackson().getTracks().forEach((value)-> System.out.println(value.getId() + " " + value.getName()));
    }
